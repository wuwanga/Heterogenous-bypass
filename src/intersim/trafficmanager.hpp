...
public:
   ...
   //UNT added
   Stats **_latency_stats_sep; //Calculate the latency of different flit seperately
   ...
   void _GeneratePacket( int source, int size, int cl, int time, void* data, int dest, int _nets );
...
public:
   ...
   TrafficManager( const Configuration &config, Network *net,int uid, int seperate_network_ratio );
   ~TrafficManager( );
