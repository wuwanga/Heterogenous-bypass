                           ...
                           int inputs, int outputs, int seperate_network_ratio, int net_num )
{
   ...
   if ( type == "iq" ) {
      r = new IQRouter( config, parent, name, id, inputs, outputs, seperate_network_ratio, net_num  );
   } else if ( type == "event" ) {
      r = new EventRouter( config, parent, name, id, inputs, outputs, seperate_network_ratio, net_num );
   } else {
